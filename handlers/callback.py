...
async def bot_set(_, query: CallbackQuery):
    ...
    await query.edit_message_text(
        f"""**^ 𝐔𝐩𝐥𝐨𝐚𝐝𝐢𝐧𝐠 𝐒𝐨𝐨𝐧 🎸 𝐓𝐡𝐞 𝐒𝐨𝐮𝐫𝐜𝐞 𝐂𝐨𝐝𝐞 𝐨𝐟 𝐭𝐡𝐞 𝐁𝐨𝐭 𝐢𝐬 𝐑𝐞𝐚𝐝𝐲 <3 𝐈𝐟 𝐰𝐞 𝐆𝐞𝐭 𝐆𝐨𝐨𝐝 𝐑𝐞𝐬𝐩𝐨𝐧𝐬𝐞 𝐅𝐫𝐨𝐦 𝐓𝐡𝐢𝐬 𝐁𝐨𝐭 , 𝐓𝐡𝐞 𝐒𝐨𝐮𝐫𝐜𝐞 𝐂𝐨𝐝𝐞 𝐏𝐫𝐨𝐯𝐢𝐝𝐞𝐝 𝐓𝐨 𝐘𝐨𝐮 𝐄𝐚𝐫𝐥𝐲 𝐀𝐬 𝐏𝐨𝐬𝐬𝐢𝐛𝐥𝐞 ✅ ^**""",
        reply_markup=InlineKeyboardMarkup(
...
async def owner_set(_, query: CallbackQuery):
    ...
    await query.edit_message_text(
        f"""**𝐀𝐝𝐝 𝐭𝐡𝐢𝐬 𝐏𝐨𝐰𝐞𝐫𝐅𝐮𝐥 𝐁𝐨𝐭 𝐈𝐧 𝐘𝐨𝐮𝐫 𝐆𝐫𝐨𝐮𝐩 ^ 𝐓𝐡𝐞𝐧 𝐏𝐫𝐨𝐦𝐨𝐭𝐞 𝐀𝐬 𝐀𝐝𝐦𝐢𝐧 𝐖𝐢𝐭𝐡 𝐍𝐞𝐞𝐝𝐞𝐝 𝐏𝐨𝐰𝐞𝐫𝐬 & 𝐂𝐚𝐥𝐥 𝐀 𝐀𝐝𝐦𝐢𝐧 𝐓𝐨 𝐒𝐞𝐧𝐝 /play 𝐂𝐨𝐦𝐦𝐚𝐧𝐝 𝐓𝐨 𝐈𝐧𝐯𝐢𝐭𝐞 𝐓𝐡𝐞 𝐌𝐮𝐬𝐢𝐜 𝐀𝐬𝐬𝐢𝐬𝐭𝐚𝐧𝐭 𝐈𝐧 𝐓𝐡𝐞 𝐆𝐫𝐨𝐮𝐩 🎸 
